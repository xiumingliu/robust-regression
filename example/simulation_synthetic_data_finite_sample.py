...
MSE_const_max = np.max(MSE_const, axis=1)
MSE_unconst_max = np.max(MSE_unconst, axis=1)
MSE_biweight_max = np.max(MSE_biweight, axis=1)
MSE_combine_max = np.max(MSE_combine, axis=1)

MSE_const_min = np.min(MSE_const, axis=1)
MSE_unconst_min = np.min(MSE_unconst, axis=1)
MSE_biweight_min = np.min(MSE_biweight, axis=1)
MSE_combine_min = np.min(MSE_combine, axis=1)
